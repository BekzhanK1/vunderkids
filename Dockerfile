...
CMD ["sh", "-c", "gunicorn vunderkids.wsgi --bind 0.0.0.0:8000 & python manage.py migrate & celery -A vunderkids worker --loglevel=info & celery -A vunderkids beat --loglevel=info"]
